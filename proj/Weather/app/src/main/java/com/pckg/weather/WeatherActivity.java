...
public class WeatherActivity extends AppCompatActivity
{
    ...
    String Location ="Location does not exist", Description, IconId, IconUrl;
    String Date;
    ...
    public void goToSecondLastActivity(View view)
    {
        ...
        intentGoToSecondLast.putExtra("PLACE",urlMid);
        intentGoToSecondLast.putExtra("JSONSTR",jsonStr);
